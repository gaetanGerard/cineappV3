...
const PeopleState = props => {
    ...
    const fetchPeopleDetail = async idPassedUrl => {
        setLoading();
        const res = await axios.get(`https://cors-anywhere.herokuapp.com/https://api.themoviedb.org/3/person/${idPassedUrl}?api_key=59c76c5b0623517c046a93a7c472e779&language=fr-FR`);
        dispatch({
    ...
    const fetchPeopleCombinedCredits = async idPassedUrl => {
        setLoading();
        const res = await axios.get(`https://cors-anywhere.herokuapp.com/https://api.themoviedb.org/3/person/${idPassedUrl}/combined_credits?api_key=59c76c5b0623517c046a93a7c472e779&language=fr-FR`);
        dispatch({
