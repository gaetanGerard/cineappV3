...
const SearchState = props => {
    ...
    const search = async (text, page = 1) => {
        ...
        const res = await axios.get(`https://api.themoviedb.org/3/search/multi?api_key=${process.env.REACT_APP_TMDB_API_KEY}&language=fr-FR&query=${text}&page=${page}&include_adult=false`);
